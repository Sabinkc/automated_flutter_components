...
//       case 'Radar Chart':
//         chartWidget = _buildPlaceholder('Radar Chart');
//         break;
//       case 'Gauge Chart':
//         chartWidget = _buildPlaceholder('Gauge Chart');
//         break;
//       default:
...
//           BarChartGroupData(x: 2, barRods: [BarChartRodData(toY: 4, color: Colors.green)]),
...
//     return const Text(
//       'Heatmap rendering requires custom implementation.',
//       style: TextStyle(fontSize: 16, color: Colors.grey),
//       textAlign: TextAlign.center,
//     );
//   }

//   // Placeholder for unsupported charts
//   Widget _buildPlaceholder(String chartType) {
//     return Text(
//       '$chartType rendering is not yet implemented.',
